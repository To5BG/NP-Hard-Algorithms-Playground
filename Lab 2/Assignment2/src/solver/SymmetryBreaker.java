...
class SymmetryBreaker {
    ...
    PentaFunction<Map<String, Object>, String, Integer, Integer, Integer[], Boolean> checkSymmetry;
    ...
    public SymmetryBreaker(PentaFunction<Map<String, Object>, String, Integer, Integer, Integer[], Boolean>
                                   checkSymmetry,
